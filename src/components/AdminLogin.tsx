            ...
            <div className="w-full max-w-md bg-white/90 backdrop-blur-xl p-10 rounded-[2.5rem] shadow-2xl border border-white/20">
                ...
                <form onSubmit={handleLogin} className="space-y-4">
                    ...
                    <div className="space-y-1">
                        <div className="relative">
                            ...
                            <input
                                ...
                                className={`w-full pl-12 pr-4 py-4 text-black rounded-2xl bg-white border outline-none focus:ring-4 transition-all font-medium ${
                                    errors.email ? "border-red-400 focus:ring-red-500/10" : "border-slate-200 focus:ring-blue-500/10"
                                }`}
                                value={email}
                    ...
                    <div className="space-y-1">
                        <div className="relative">
                            ...
                            <input
                                ...
                                className={`w-full pl-12 pr-4 py-4 rounded-2xl text-black bg-white border outline-none focus:ring-4 transition-all font-medium ${
                                    errors.password ? "border-red-400 focus:ring-red-500/10" : "border-slate-200 focus:ring-blue-500/10"
                                }`}
                                value={password}
                    ...
                    <button
                        disabled={loading}
                        type="submit"
                        className="w-full bg-blue-600 text-white py-4 rounded-2xl font-black text-lg shadow-lg shadow-blue-200 hover:bg-blue-700 hover:-translate-y-0.5 active:scale-95 transition-all mt-4 disabled:bg-slate-400 uppercase tracking-widest"
                    >
